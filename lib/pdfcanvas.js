...
(function () {
    ...
    contextPrototype.fillText = function(text, x, y, maxWidth, fontSize, geom) {
        ...
        this.currentFont.processText(p, text, maxWidth, color, fontSize, this.canvas, this.m_, geom);
    };
